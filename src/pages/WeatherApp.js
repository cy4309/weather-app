...
import sunriseAndSunsetData from "../store/sunrise-sunset.json";
...
const WeatherApp = () => {
  ...
  return (
    <ThemeProvider theme={theme[currentTheme]}>
      <Container>
        {currentPage === "WeatherCard" && <WeatherCard cityName={currentLocation.cityName} weatherElement={weatherElement} moment={moment} fetchData={fetchData} setCurrentPage={setCurrentPage} />}
